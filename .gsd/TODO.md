...
- [ ] **Panning/Scrolling**: Implement simulation space scrolling and repositioning of the view of the simulation (allow users to drag/pan the canvas viewport). `medium` — 2026-06-07
