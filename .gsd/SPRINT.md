...
|------|----------|--------|------------|
| Design and implement slack-string projectile fallback equations in `MechanicsDiagram.ts` | Claude | ⬜ Todo | 2 |
| Update rendering for slack string and circular motion UI sliders in `main.ts` | Claude | ⬜ Todo | 1 |
| Verify correct physics simulation behavior visually in the browser | Claude | ⬜ Todo | 0.5 |
